...
@Delimiter("DEBITOS")
public class HeaderWithDebitsDelimiter implements RecordLayout {

    public HeaderWithDebitsDelimiter() {}

    public HeaderWithDebitsDelimiter(final String title) {
        this.title = title;
    }

    @FieldPosition(begin = 0, end = 7)
    ...
    public boolean equals(Object o) {
        ...
        HeaderWithDebitsDelimiter header = (HeaderWithDebitsDelimiter) o;
